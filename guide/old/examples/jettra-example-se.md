...
public class SqlExample {
    ...
    public static void main(String[] args) {
        ...
        try {
            // Autenticamos para obtener y configurar el token automáticamente
            client.login("admin", "admin").await().indefinitely();
            ...
            System.err.println("Error durante la ejecución SQL: " + e.getMessage());
        }
    }
}
```
